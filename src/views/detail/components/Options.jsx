        ...
        <div className="w-50 me-3">
          ...
          >
            {colorOptions.map((colorOption, index) => {
              return (
                <OptionItem
                  key={`color-option-${colorOption.name.toLowerCase()}`}
                  name={colorOption.name}
                  radioGroupName="color"
        ...
        <div className="w-50 ms-3">
          ...
          >
            {storageOptions.map((storageOption, index) => {
              return (
                <OptionItem
                  key={`storage-option-${storageOption.name.toLowerCase()}`}
                  name={storageOption.name}
                  radioGroupName="storage"
